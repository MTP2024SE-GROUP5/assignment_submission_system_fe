...
import { usePublishAssignment } from './usePublishAssignment';
...
describe('usePublishAssignment', () => {
    ...
    it('mounts without crashing and triggers', async () => {
        const { result } = renderHookWithProviders(() => {
            try {
                return usePublishAssignment('mockId' as any, { enabled: true } as any);
            } catch {
                try {
                    return usePublishAssignment();
                } catch {
                    return null;
                }
            }
