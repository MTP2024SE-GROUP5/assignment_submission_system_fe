...
import { useGetAllAssignments } from './useGetAllAssignments';
...
describe('useGetAllAssignments', () => {
    ...
    it('mounts without crashing and triggers', async () => {
        const { result } = renderHookWithProviders(() => {
            try {
                return useGetAllAssignments('mockId' as any, { enabled: true } as any);
            } catch {
                try {
                    return useGetAllAssignments();
                } catch {
                    return null;
                }
            }
