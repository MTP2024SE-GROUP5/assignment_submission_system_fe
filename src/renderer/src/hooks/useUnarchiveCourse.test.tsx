...
import { useUnarchiveCourse } from './useUnarchiveCourse';
...
describe('useUnarchiveCourse', () => {
    ...
    it('mounts without crashing and triggers', async () => {
        const { result } = renderHookWithProviders(() => {
            try {
                return useUnarchiveCourse('mockId' as any, { enabled: true } as any);
            } catch {
                try {
                    return useUnarchiveCourse();
                } catch {
                    return null;
                }
            }
