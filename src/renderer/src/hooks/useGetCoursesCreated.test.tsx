...
import { useGetCoursesCreated } from './useGetCoursesCreated';
...
describe('useGetCoursesCreated', () => {
    ...
    it('mounts without crashing and triggers', async () => {
        const { result } = renderHookWithProviders(() => {
            try {
                return useGetCoursesCreated('mockId' as any, { enabled: true } as any);
            } catch {
                try {
                    return useGetCoursesCreated();
                } catch {
                    return null;
                }
            }
