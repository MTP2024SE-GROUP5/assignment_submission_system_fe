...
import { useStudentGetGrade } from './useStudentGetGrade';
...
describe('useStudentGetGrade', () => {
    ...
    it('mounts without crashing and triggers', async () => {
        const { result } = renderHookWithProviders(() => {
            try {
                return useStudentGetGrade('mockId' as any, { enabled: true } as any);
            } catch {
                try {
                    return useStudentGetGrade();
                } catch {
                    return null;
                }
            }
